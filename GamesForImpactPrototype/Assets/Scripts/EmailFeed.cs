...
public class EmailFeed : MonoBehaviour
{
    public float minWaitTime;
    public float maxWaitTime;

    public Sprite[] emails;
    ...
    private void Start()
    {
        ...
        emailSize = contentRenderer.bounds.size; // world size of single post
    ...
    public void NewPost()
    {
        ...
        int newPostIndex = Random.Range(0, emails.Length);

        // Add new post sprite to feed
        AddSprite(emails[newPostIndex]);
    }
